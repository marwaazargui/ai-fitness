    ...
    <div className="max-w-2xl mx-auto mt-14 ">
      ...
      <div className="space-y-6 bg-white rounded-2xl shadow p-8">
        ...
        <div className="flex items-center gap-6">
          ...
          <span className="text-gray-900 font-semibold text-lg">Marwa</span>
        </div>

        {/* Last Name */}
        <div className="flex items-center gap-6">
          <span className="w-40 text-gray-500 font-medium">Last Name</span>
          <span className="text-gray-900 font-semibold text-lg">Azargui</span>
        </div>

        {/* Email */}
        <div className="flex items-center gap-6">
          <span className="w-40 text-gray-500 font-medium">Email</span>
          <span className="text-gray-900 font-semibold text-lg">marwa@example.com</span>
        </div>
      </div>
    </div>
  );
